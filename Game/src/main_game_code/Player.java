...
public class Player implements KeyListener{		//keyListener added in the Game Class
	...
	private int teleport_bar;			//A variable that checks the current time with when the space bar has been last pressed.	
	...
	public Player(SpriteSheet sheet, Camera camera, World world) {
		...
		health = 200;	//health (subject to change)
	...
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_W:
			...
			if (falling == false) {		// if W was pressed, set jump to -10 (go up) and set jumped to true. Also get the last known y coordinate
				yVel = -13;			//before jumping (temporary solution to jumping. Will be improved with collision detection later)
	...
	public void render(Graphics g) {
		...
		g.fillRect(7, 36,teleport_bar,18);
		g.setColor(Color.RED);
		g.fillRect(7, 7,health, 18);

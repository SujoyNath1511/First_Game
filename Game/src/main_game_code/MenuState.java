...
public class MenuState  {
	private BufferedImage laser_gun, laser, skull, wasdKeys, mouseImg, spaceBar, keyA, keyD;
	private int state;
	...
	public MenuState(Frame frame, MouseManager mouse, Game game) {
		...
		wasdKeys = ImageLoader.loadImage("/textures/wasd_keys.png");
		mouseImg = ImageLoader.loadImage("/textures/mouse_leftclick.png");
		spaceBar = ImageLoader.loadImage("/textures/space_bar.png");
		keyA = ImageLoader.loadImage("/textures/key_a.png");
		keyD = ImageLoader.loadImage("/textures/key_d.png");
		this.mouse = mouse;
		this.game = game;
	}
	public int isState() {
	...
	public void render(Graphics g) {
		if (state == 0) {
			...
			g.drawString("Welcome To Jumanji", 125, 100);

...
import main_game_code.Projectile;
...
public class World {
	...
	public void generateEnemies (Player player, SpriteSheet sheet) {
		...
		enemies[5] = new Enemy_Stats(50,15,1,3350,112,camera,player,sheet,1);
		enemies[6] = new Enemy_Stats(50,15,1,5080,107,camera,player,sheet,1);
		enemies[7] = new Enemy_Stats(50,15,1,5280,104,camera,player,sheet,1);
		enemies[8] = new Enemy_Stats(50,15,1,5465,53,camera,player,sheet,1);
		//enemies[10] = new Enemy_Stats(50,15,1,5565,98,camera,player,sheet,1);
		enemies[9] = new Enemy_Stats(50,15,1,5705,115,camera,player,sheet,1);
		// ------------------------Type 2  ------------------------------//
		enemies[10] = new Enemy_Stats(200,5,2,1145,528,camera,player,sheet,1);
		enemies[11] = new Enemy_Stats(200,5,2,3775,535,camera,player,sheet,1);
		enemies[12] = new Enemy_Stats(200,5,2,4105,535,camera,player,sheet,1);
		enemies[13] = new Enemy_Stats(200,5,2,4990,314,camera,player,sheet,1);
		//-----------------------Type 3 -------------------------------//
		enemies[14] = new Enemy_Stats(100,30,3,1120,385,camera,player,sheet,1);
		enemies[15] = new Enemy_Stats(100,30,3,1185,385,camera,player,sheet,1);
		enemies[16] = new Enemy_Stats(100,30,3,835,257,camera,player,sheet,1);
		enemies[17] = new Enemy_Stats(100,30,3,930,257,camera,player,sheet,1);
		enemies[18] = new Enemy_Stats(100,30,3,1616,442,camera,player,sheet,1);
		enemies[19] = new Enemy_Stats(100,30,3,1796,350,camera,player,sheet,1);
		enemies[20] = new Enemy_Stats(100,30,3,2031,268,camera,player,sheet,1);
		enemies[21] = new Enemy_Stats(100,30,3,2181,392,camera,player,sheet,1);
		...
		enemies[23] = new Enemy_Stats(100,30,3,3380,321,camera,player,sheet,1);
		enemies[24] = new Enemy_Stats(100,30,3,4330,421,camera,player,sheet,1);
		...
		enemies[25] = new Enemy_Stats(100,30,3,4255,300,camera,player,sheet,1);
		enemies[26] = new Enemy_Stats(100,30,3,4158,101,camera,player,sheet,1);
		enemies[27] = new Enemy_Stats(100,30,3,4543,301,camera,player,sheet,1);
		//enemies[28] = new Enemy_Stats(100,30,3,5205,314,camera,player,sheet,1);
		enemies[28] = new Enemy_Stats(100,30,3,5510,172,camera,player,sheet,1);
		//enemies[30] = new Enemy_Stats(100,30,3,5645,172,camera,player,sheet,1);
		enemies[29] = new Enemy_Stats(100,30,3,5810,172,camera,player,sheet,1);
		enemies[30] = new Enemy_Stats(100,30,3,6015,172,camera,player,sheet,1);
